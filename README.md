...
- Sends Directorist directory builder strings to WPML Advanced Translation Editor from the builder edit screen and All Directories screen.
...
- Added WPML Advanced Translation Editor package jobs for Directorist directory builder strings from the builder edit screen and All Directories screen.
