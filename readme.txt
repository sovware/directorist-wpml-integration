...
* Added: WPML Advanced Translation Editor package jobs for Directorist directory builder strings, available from the builder edit screen and All Directories translation action.
